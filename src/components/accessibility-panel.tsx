        ...
        <>
          ...
          <div className="fixed bottom-20 left-6 z-50 w-72 rounded-lg border border-charcoal/20 bg-bone p-4 shadow-xl dark:border-bone/20 dark:bg-charcoal">
            ...
            <div className="space-y-4">
              <fieldset>
                <legend className="mb-2 text-sm font-medium text-charcoal/70 dark:text-bone/70">Font Size</legend>
              ...
              <fieldset>
                <legend className="mb-2 text-sm font-medium text-charcoal/70 dark:text-bone/70">Line Spacing</legend>
                <div className="flex gap-2">
                  {(['default', 'relaxed', 'loose'] as const).map((v) => (
                    ...
                    >
                      {v === 'default' ? 'Normal' : v === 'relaxed' ? 'Relaxed' : 'Loose'}
                    </button>
                  ))}
                </div>
              </fieldset>
              ...
              <fieldset>
                <legend className="mb-2 text-sm font-medium text-charcoal/70 dark:text-bone/70">Contrast</legend>
                <div className="flex gap-2">
              ...
              <fieldset>
                <legend className="mb-2 text-sm font-medium text-charcoal/70 dark:text-bone/70">Motion</legend>
                <div className="flex gap-2">
