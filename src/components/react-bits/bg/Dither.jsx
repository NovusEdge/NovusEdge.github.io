...
function DitheredWaves({
  ...
  // r3f clones the uniforms object it receives via the `uniforms` prop, so the
  // GPU reads the material's own copy, not waveUniformsRef. Every live update
  // has to target mesh.current.material.uniforms or it never reaches the shader.
  useEffect(() => {
