...
description: Uploading a malicious WAR file to a vulnerable Tomcat manager for a reverse shell on TryHackMe's ToolsRus room, then persisting with an SSH key.
---
